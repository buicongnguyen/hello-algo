...
Các cấu trúc dữ liệu thường gặp gồm mảng, danh sách liên kết, ngăn xếp, hàng đợi, bảng băm, cây, đống và đồ thị. Ta có thể phân loại chúng theo hai góc nhìn: **cấu trúc logic** và **cấu trúc vật lý**.
...
Sau khi khởi tạo, danh sách liên kết vẫn có thể thay đổi độ dài trong lúc chương trình chạy nên thường được gọi là cấu trúc dữ liệu động. Độ dài của mảng cố định sau khi khởi tạo nên mảng thường được xem là cấu trúc dữ liệu tĩnh. Tuy vậy, ta có thể tạo một mảng mới lớn hơn rồi sao chép dữ liệu để đạt được mức linh hoạt có giới hạn.
