...
2. **Tìm lời giải tốt hơn:** một bài toán có thể có nhiều cách giải; sau khi bảo đảm tính đúng đắn, ta muốn chọn thuật toán hiệu quả nhất có thể.
...
Mục tiêu ngắn gọn là thiết kế cấu trúc dữ liệu và thuật toán **vừa nhanh, vừa tiết kiệm bộ nhớ**. Muốn so sánh và tối ưu một cách có cơ sở, trước hết ta cần phương pháp đánh giá hiệu quả.
...
Muốn có kết luận tổng quát, ta phải thử trên nhiều cấu hình và tổng hợp kết quả. Cách làm này tốn kém và đôi khi không thực tế.
...
Để giảm những hạn chế trên, ta có thể đánh giá bằng tính toán lý thuyết. Phương pháp này gọi là **phân tích độ phức tạp tiệm cận**, thường rút gọn thành **phân tích độ phức tạp**.
...
- “Khi kích thước đầu vào tăng” nghĩa là ta xem hiệu quả thay đổi cùng quy mô dữ liệu.
- “Xu hướng tăng trưởng” nghĩa là ta không quá quan tâm một con số mili giây hay megabyte cụ thể, mà quan tâm thời gian hoặc bộ nhớ tăng nhanh đến mức nào.
...
> Phân tích lý thuyết không thay thế hoàn toàn phép đo. Nó cho biết xu hướng mở rộng; benchmark thực tế cho biết hằng số, tác động phần cứng và hành vi của một triển khai cụ thể. Trong kỹ thuật tốt, hai phương pháp bổ sung cho nhau.
