...
**Ví dụ 1: Tra từ điển.** Trong từ điển tiếng Anh, các từ được sắp xếp theo thứ tự bảng chữ cái. Giả sử cần tìm một từ bắt đầu bằng chữ $r$, chúng ta thường làm như sau:
...
**Ví dụ 2: Sắp xếp bài trên tay.** Khi chơi bài, chúng ta thường xếp các lá trên tay theo thứ tự tăng dần:
...
**Ví dụ 3: Trả lại tiền thừa.** Giả sử bạn mua hàng hết $69$ đồng và đưa cho thu ngân $100$ đồng. Thu ngân cần trả lại $31$ đồng. Một cách thực hiện là:
...
Ví dụ trả tiền này minh họa tư tưởng tham lam trong hệ mệnh giá đã cho. Với một số hệ mệnh giá khác, luôn chọn đồng tiền lớn nhất có thể không tạo ra phương án dùng ít đồng nhất; bởi vậy tính đúng đắn của thuật toán tham lam phải được chứng minh cho từng hệ quy tắc cụ thể.
