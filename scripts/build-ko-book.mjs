...
const corePages = [
  ...
  ["intro-to-dynamic-programming", "동적 계획법 입문", "14.1 · 입문", "14장", "en/docs/chapter_dynamic_programming/intro_to_dynamic_programming.md", "ko/docs/chapter_dynamic_programming/intro_to_dynamic_programming.md", "완전 탐색 재귀에서 메모이제이션과 표 채우기로 발전합니다."],
  ...
  ["unbounded-knapsack", "완전 배낭 문제", "14.5 · 완전 배낭", "14장", "en/docs/chapter_dynamic_programming/unbounded_knapsack_problem.md", "ko/docs/chapter_dynamic_programming/unbounded_knapsack_problem.md", "물건 종류를 재사용하고 동전 교환 변형을 풉니다."],
  ["edit-distance", "편집 거리 문제", "14.6 · 편집 거리", "14장", "en/docs/chapter_dynamic_programming/edit_distance_problem.md", "ko/docs/chapter_dynamic_programming/edit_distance_problem.md", "삽입, 삭제, 교체로 문자열 유사도를 측정합니다."],
  ...
  ["fractional-knapsack", "분할 가능 배낭 문제", "15.2 · 분할 가능 배낭", "15장", "en/docs/chapter_greedy/fractional_knapsack_problem.md", "ko/docs/chapter_greedy/fractional_knapsack_problem.md", "단위 가치가 높은 순서로 나눌 수 있는 물건을 선택합니다."],
  ...
  ["greedy-exercises", "그리디 연습문제", "15.6 · 연습문제", "15장", "en/docs/chapter_greedy/exercises.md", "ko/docs/chapter_greedy/exercises.md", "그리디 반례, 두 포인터와 분할 가능 배낭을 연습합니다."],
...
<body data-reader-source="${page.source}" data-translation-status="${koreanDocument.status}">
  ...
  <header class="reader-header">
    ...
    <nav aria-label="언어와 테마"><a class="active" href="${outputName || "./"}" lang="ko" hreflang="ko" aria-current="page">KO</a><a href="${viUrl}" lang="vi" hreflang="vi" aria-label="같은 문서를 베트남어로 읽기">VI</a><a href="${englishReaderHref(page.source)}" lang="en" hreflang="en" aria-label="같은 문서를 영어로 읽기">EN</a><button id="reader-search-open" type="button" aria-label="책에서 검색">⌕</button><button id="reader-theme" type="button" aria-label="밝은 테마" aria-pressed="false">◐</button></nav>
  </header>
  <div class="reader-shell">
    <aside class="reader-sidebar" id="reader-sidebar" aria-label="한국어판 목차"><div class="sidebar-top"><strong>한국어 읽기</strong><small>0–16장 · ${statusCopy.sidebar}</small></div>${navigation(page.slug)}<div class="sidebar-links"><a href="../#roadmap">학습 지도</a><a href="https://buicongnguyen.github.io/Modern_c_20/ko/">모던 C++20 가이드</a><a href="https://github.com/buicongnguyen/hello-algo/blob/main/KOREAN_TRANSLATION_PLAN.md">번역 계획</a><a href="https://github.com/buicongnguyen/hello-algo/blob/main/ko/glossary.md">용어집</a><a href="https://github.com/buicongnguyen/hello-algo/blob/main/ko/CONTRIBUTING.md">기여하기</a></div></aside>
