...
const stableEnglishReaderRoutes = new Map([
  ...
  ["en/docs/chapter_dynamic_programming/exercises.md", "en/learn/dynamic-programming-exercises.html"],
  ...
  ["en/docs/chapter_greedy/exercises.md", "en/learn/greedy-exercises.html"],
