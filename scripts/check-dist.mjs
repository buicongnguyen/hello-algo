...
export async function checkBuiltSite(outputRoot) {
  ...
  if ((vietnameseDpIntro.match(/class="content-tabs"/g) || []).length !== 5 ||
      ...
      (vietnameseDynamicProgramming.match(/class="content-tabs"/g) || []).length !== 2 ||
